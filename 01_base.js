...
console.log(person.firstName)    //1й способ обращения к свойству
console.log(person['firstName']) //2й способ обращения к свойству
const key = 'firstName'          
console.log(person[key])         //3й способ обращения к свойству
person.greet() //обращение к методу
